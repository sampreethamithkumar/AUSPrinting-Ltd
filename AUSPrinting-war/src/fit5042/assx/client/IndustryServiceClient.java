...
public class IndustryServiceClient {
    ...
    private static final String BASE_URI = "http://0.0.0.0:8080/AUSPrinting-war/webresources";

    public IndustryServiceClient() {
    ...
    public void setPostIndustryParams(String industryType) throws ClientErrorException {
    	Form form = new Form();
    	form.param("industryType", industryType);
